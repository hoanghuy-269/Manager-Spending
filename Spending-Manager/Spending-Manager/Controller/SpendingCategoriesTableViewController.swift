...
class SpendingCategoriesTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "Danh Mục Chi Tiêu"
        self.navigationItem.backBarButtonItem = UIBarButtonItem(title: "", style: .plain, target: nil, action: nil)
        loadData()
    }
    
    func loadData(){
        categories = AppDatabase.shared.getCategoriesByTransactionTypeId(TransactionTypeId.chiTieu.rawValue)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? AddSpendingViewController {
...
extension SpendingCategoriesTableViewController {
